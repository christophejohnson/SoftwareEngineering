...
public class Member
{
    ...
    private static int maxStandardBorrow = 3;
    private static int maxPremiumBorrow = 5;
    private static int maxVipBorrow = 10;
    ...
    private int GetMaxBorrowLimit()
    {
        if (MembershipLevel == "Standard")
            return maxStandardBorrow;
        else if (MembershipLevel == "Premium")
            return maxPremiumBorrow;
        else if (MembershipLevel == "V.I.P")
            return maxVipBorrow;
        else
