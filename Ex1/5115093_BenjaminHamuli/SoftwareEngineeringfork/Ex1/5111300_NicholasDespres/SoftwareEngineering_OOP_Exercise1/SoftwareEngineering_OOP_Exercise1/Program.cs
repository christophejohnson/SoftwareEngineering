public class Program
{
    public static void Main(string[] args)
    {
        ...
        Member m1 = new Member("Ozzy Osbourne", 76, "Standard");
        Member m2 = new Member("Guthrie Govan", 55, "Premium");
        Member m3 = new Member("Neil Peart", 67, "V.I.P");
        ...
        Console.WriteLine($"Name: {m1.Name}, Age: {m1.Age}, Level: {m1.MembershipLevel}, Books Borrowed {m1.GetBooksBorrowed}");
        Console.WriteLine($"Name: {m2.Name}, Age: {m2.Age}, Level: {m2.MembershipLevel}, Books Borrowed {m2.GetBooksBorrowed}");
        Console.WriteLine($"Name: {m3.Name}, Age: {m3.Age}, Level: {m3.MembershipLevel}, Books Borrowed {m3.GetBooksBorrowed}");
